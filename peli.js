...
/* Funktio, joka muuntaa kirjaimet sanoiksi vastausriviä varten */
...
function voitto(kayttajanValinta, tietsikanValinta){
    ...
    vastaus_article.innerHTML =  muunnaKirjaimetSanoiksi(kayttajanValinta) + " on voimaakkaampi kuin " +  muunnaKirjaimetSanoiksi(tietsikanValinta) + ". Sinä voitit!";
    /* Laitetaan renkaaseen vihreä reunus sekunniksi, kun tulee voitto */
    document.getElementById(kayttajanValinta).classList.add('green-glow');
    setTimeout(function(){ document.getElementById(kayttajanValinta).classList.remove('green-glow') }, 3000);
    /* Voidaan kirjoittaa myös muodossa
    setTimeout(()=>document.getElementById(kayttajanValinta).classList.remove('green-glow'),3000); */
}
...
function tappio(kayttajanValinta, tietsikanValinta){
    ...
    kPisteet_span.innerHTML = kPisteet;
    /* Kirjoitetaan näkyviin myös kilpailun tulos */
    vastaus_article.innerHTML =  muunnaKirjaimetSanoiksi(tietsikanValinta) + " on voimaakkaampi kuin " +  muunnaKirjaimetSanoiksi(kayttajanValinta) + ". Sinä hävisit!";
    /* Laitetaan renkaaseen punainen reunus sekunniksi, kun tulee tappio */
    document.getElementById(kayttajanValinta).classList.add('red-glow');
    setTimeout(function(){ document.getElementById(kayttajanValinta).classList.remove('red-glow') }, 3000);
...
function tasapeli(kayttajanValinta, tietsikanValinta){
    ...
    tPisteet_span.innerHTML = tPisteet;
    kPisteet_span.innerHTML = kPisteet;
    /* Laitetaan renkaaseen harmaa reunus sekunniksi, kun tulee tasapeli */
    document.getElementById(kayttajanValinta).classList.add('gray-glow');
    setTimeout(function(){ document.getElementById(kayttajanValinta).classList.remove('gray-glow') }, 1000);
    /* Kirjoitetaan näkyviin myös kilpailun tulos */
